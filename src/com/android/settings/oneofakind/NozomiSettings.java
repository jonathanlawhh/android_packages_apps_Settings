...
public class NozomiSettings extends SettingsPreferenceFragment
        implements OnPreferenceChangeListener {
    private static final String TAG = "NozomiSettings";
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.nozomi_settings);
